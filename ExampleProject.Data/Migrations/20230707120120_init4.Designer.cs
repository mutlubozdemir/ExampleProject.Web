...
namespace ExampleProject.Data.Migrations
{
    ...
    [Migration("20230707120120_init4")]
    partial class init4
    {
            ...
            modelBuilder.Entity("ExampleProject.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9cbce099-2f3f-40e8-ac43-b12f5046e79e",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6eb4d956-a83d-47ca-b198-3382e96aae95",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2437ad03-81c4-4331-bec4-7b3e23679d36",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("ExampleProject.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a2799f75-4980-4741-9c36-b541377d53bf",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMGiMtF/mjmkMj4K5FuhRGVt+pJjXbZe73JZQQbhTIocM5V1NMDSfs8mtKoSAHDw1g==",
                            PhoneNumber = "+905000000000",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "3b873d52-b230-47ef-8d36-a12834799bfd",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2d1f0027-eb3e-45bb-9bc1-e2568b4e0f53",
                            ...
                            PhoneNumber = "+905000000000",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "782d0b34-7b1b-4fb2-86cd-d7ee376e3173",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("ExampleProject.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("331441f2-c04e-45b5-ab86-bb97be6133e1"),
                            CategoryId = new Guid("50fa1ca4-6559-4543-b545-033bdd167c2d"),
                            Content = ".........................",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 7, 7, 15, 1, 20, 21, DateTimeKind.Local).AddTicks(8888),
                            ImageId = new Guid("a14b14f8-a193-4940-a67f-abfef7e542a0"),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("de3ea2c5-587a-4a65-87f2-785b87d98713"),
                            CategoryId = new Guid("282dd9b5-e65d-44ca-b319-26505de1795b"),
                            Content = "Visual Studio.........................",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 7, 7, 15, 1, 20, 21, DateTimeKind.Local).AddTicks(8895),
                            ImageId = new Guid("5447d768-e04d-4ee3-8cb7-cd9522df5465"),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("ExampleProject.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 7, 7, 15, 1, 20, 21, DateTimeKind.Local).AddTicks(9092),
                            IsDeleted = false,
                            Name = "Asp.net Corew"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 7, 7, 15, 1, 20, 21, DateTimeKind.Local).AddTicks(9096),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("ExampleProject.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 7, 7, 15, 1, 20, 21, DateTimeKind.Local).AddTicks(9191),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 7, 7, 15, 1, 20, 21, DateTimeKind.Local).AddTicks(9197),
